...
//           "https://blog-mern-back-7ao5.onrender.com/api/blogs/my-blog",
...
//     await axios
//       .delete(`https://blog-mern-back-7ao5.onrender.com/api/blogs/delete/${id}`, {
//         withCredentials: true,
//       })
//       .then((res) => {
  ...
  const handleDelete = async (id) => {
    try {
      const res = await axios.delete(
        `https://blog-mern-back-7ao5.onrender.com/api/blogs/delete/${id}`,
        { withCredentials: true }
      );
      toast.success(res.data.message || "Blog deleted successfully");
      setMyBlogs((value) => value.filter((blog) => blog._id !== id));
